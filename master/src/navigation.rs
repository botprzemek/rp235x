...
pub fn Navbar(props: &NavbarProps) -> Html {
    html! {
        <aside style="background-color: #0f172a; padding: 8px 12px; display: flex; justify-content: space-between; align-items: center;">
            ...
            <button onclick={&props.on_toggle_controls} style="background: transparent; border: 1px solid #475569; color: #f8fafc; font-size: 11px; padding: 2px 8px; border-radius: 4px; cursor: pointer;">
